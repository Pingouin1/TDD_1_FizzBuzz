...
public class FizzBuzzTest {
    ...
    @Test
    public final void fizzbuzz_should_return_empty_string_if_not_dividable_by_three_or_five() {
        int n = 1;
    ...
    @Test
    public final void fizzbuzz_should_return_fizz_if_dividable_by_three() {
        int n = 3;
    ...
    @Test
    public final void fizzbuzz_should_return_buzz_if_dividable_by_five() {
        int n = 5;

        assertEquals("should return empty string if not dividable by three or five", "Buzz", fizzBuzz.fizzBuzz(n));
    }
    @Test
    public final void fizzbuzz_should_return_buzz_if_dividable_by_three_and_five() {
        int n = 15;
